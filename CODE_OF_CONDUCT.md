...
and will take appropriate and fair corrective action in response to behaviour
...
officially representing the community in public. Representation includes using an
...
`info@usevulcan.app` with **Code of Conduct report** in the subject. Do not open a
public issue. Reports will be reviewed fairly, and the privacy and security of the
reporter will be respected.

The project is maintained by a single company, Home Energy Foundry Limited.
Reports are received and handled by that company, and a report concerning the
maintainer has no independent internal appeal.

Community leaders will apply the following Community Impact Guidelines when
deciding consequences.

### 1. Correction

**Community impact:** Use of inappropriate language or other behaviour considered
unprofessional or unwelcome.

**Consequence:** A private written warning explaining the violation and why the
...
those enforcing this Code of Conduct, for a specified period. This includes
community spaces and external channels such as social media. Breaching these terms
...
people involved, including unsolicited interaction with those enforcing this
Code of Conduct, is allowed during that period. Breaching these terms may lead to
a permanent ban.

### 4. Permanent ban

**Community impact:** A pattern of violating community standards, including
sustained inappropriate behaviour, harassment, or aggression toward or
disparagement of classes of people.
